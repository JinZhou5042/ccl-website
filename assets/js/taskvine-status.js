...
function create_task_status_bar(manager, column) {
    ...
    svg.append("g")
      ...
      .enter().append("rect")
        ...
        .attr("stroke", "grey")
        .on("mouseover", function(d) {
          var content = d.category + ": " + parseInt(d.true_val, 10).toLocaleString();
...
function create_manager_time_pie(manager, column) {
    ...
    svg.selectAll("mydots")
        ...
        .append("rect")
        .attr("x", size)
        .attr("y", function(d,i){ return size + i*(size+5);})
        .attr("width", size)
        .attr("height", size)
    ...
    svg.selectAll("mylabels")
        ...
        .attr("y", function(d,i){ return size + i*(size+5) + (size/2);})
...
function show_task_data(container, data, refresh_url) {
    ...
    var activeTasks = data.filter(function(task) { return task.host != null; });
    var nonActiveTasks = data.filter(function(task) { return task.host == null; });

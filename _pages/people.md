...
nav_order: 7
people:
  - name: Prof. Douglas Thain
    image: assets/img/people/dthain.jpg
    designation: Director
    website: https://dthain.github.io
  - name: Benjamin Tovar
  ...
  - name: Barry Sly Delgado
    ...
    designation: Ph.D. Student
  - name: Colin Thomas
    image: assets/img/people/cthoma26.jpg
    designation: Ph.D. Student
  - name: Jin Zhou
    image: assets/img/people/jzhou24.jpg
    designation: Ph.D. Student
...
team_photos:
  ...
  - name: assets/img/team/ccl-july-2018.jpg
    caption: CCL Team, July 2018
  - name: assets/img/team/ccl-may-2018.jpg
...
- Dr. Chao "Charles" Zheng, Ph.D. 2019 — Engineer at Alibaba
- Dr. Peter Ivie, Ph.D. 2018 — Engineer at VidAngel
- Dr. James Sweet, Ph.D. 2017 — Postdoc at ND Center for Research Computing
- Dr. Haiyan Meng, Ph.D. 2017 — Engineer at Google
- Dr. Patrick Donnelly, Ph.D. 2016 — Engineer at Red Hat
- Dr. Haipeng Cai, Ph.D. 2015 — Faculty at Washington State University
- Dr. Peter Sempolinski, Ph.D. 2015 — Postdoc at Notre Dame
- Dr. Dinesh Rajan, Ph.D. 2015 — Engineer at Amazon
- Dr. Li Yu, Ph.D. 2013 — Engineer at Bloomberg
...
- Daniel Blittschau - Develop integration between Flux task executor and Makeflow workflow manager.
- Chris Boumalhab - Enhancing fault tolerance in TaskVine.
- Jon Brockett - TaskVine development.
- Thomas Hieber - TaskVine development.
- Jakhob Dolak - Prototyped consistency contracts for applications.
- David Simonetti - Developed serverless execution model in Work Queue.
- Joe Duggan - Improved performance of Python abstractions.
- Peter Ainsworth - Created a prototype Ceph filesystem for the DISC cluster.
- Carlo Preciado - Created techniques for highlighting incompatible tasks and worker summaries.
- Andrew Hennessee - Optimized data transfer workflows in TopEFT.
- Samuel Huang - Created visualization tools for Work Queue.
- Ben Lyons (M.S. 2022) - Created the Mufasa meta-workflow manager.
- Brett Wiseman - Computational abstractions in Python.
- Yifan Yu (M.S. 2020) - Capacity management for cloud workflows.
- Jack Rundle - Work Queue visualization and JX console.
- Ryan Wigglesworth - Integration of Work Queue and Binder/Jupyter.
- William McComis - Historical performance analysis of Makeflow.
- Zoe Surma - Integration of Work Queue and Coffea
- Emily Strout - Performance evaluation of Work Queue and Coffea.
...
- Caitlin Guccione (REU 2017) - Evaluated cost and performance of bioinformatics on commercial clouds.

...
(This is the short version of a talk I gave at the MTAGS workshop at Supercomputing 2013.
  <a href="http://www3.nd.edu/~dthain/talks/model-mtags13.pptx" target="_blank">
   See the slides here
  </a>
  .)
...
The layers can be described as follows:
  ...
  <ul>
   <li>
    ...
    for compactly representing a complete program.
   </li>
   <li>
    A
    <strong>
    ...
    to represent the expanded program and its resources.
   </li>
   <li>
    A
    <strong>
     bag of independent tasks (BOT)
    </strong>
    with explicit input and output dependencies.
   </li>
   <li>
    A
    <b>
    ...
    to which data and tasks must be assigned.
   </li>
  </ul>

...
image: "/assets/blog/2024/predicting-resources-of-tasks-in-dynamic-workflows-with-bucketing-algorithms-at-/workflow_architecture-e74d1462d6.jpg"
...
<p>
   ...
   at the
   <a href="https://www.ipdps.org/ipdps2024/2024-call-for-papers.html" target="_blank">
  ...
  <div class="row justify-content-sm-center">
   <div class="col-sm-12">
    {% include figure.liquid path="/assets/blog/2024/predicting-resources-of-tasks-in-dynamic-workflows-with-bucketing-algorithms-at-/workflow_architecture-e74d1462d6.jpg" title="" class="img-fluid rounded z-depth-1" zoomable=true %}
   </div>
  </div>
  <br/>
  ...
  <div class="row justify-content-sm-center">
   <div class="col-sm-12">
    {% include figure.liquid path="/assets/blog/2024/predicting-resources-of-tasks-in-dynamic-workflows-with-bucketing-algorithms-at-/img-9b5621f704.png" title="" class="img-fluid rounded z-depth-1" zoomable=true %}
   </div>
  </div>
  <p>
  ...
  <div class="row justify-content-sm-center">
   <div class="col-sm-12">
    {% include figure.liquid path="/assets/blog/2024/predicting-resources-of-tasks-in-dynamic-workflows-with-bucketing-algorithms-at-/break_and_choose-1c665dafa2.jpg" title="" class="img-fluid rounded z-depth-1" zoomable=true %}
   </div>
  </div>
  <p>
  ...
  <div class="row justify-content-sm-center">
   <div class="col-sm-12">
    {% include figure.liquid path="/assets/blog/2024/predicting-resources-of-tasks-in-dynamic-workflows-with-bucketing-algorithms-at-/img-5ac407d67b.png" title="" class="img-fluid rounded z-depth-1" zoomable=true %}
   </div>
  </div>
  <p>
  ...
  <ul style="text-align: left;">
   <li>
    ...
    <a href="http://ccl.cse.nd.edu/research/papers/adaptive-ipdps-2024.pdf">
     <b>
      Adaptive Task-Oriented Resource Allocation for Large Dynamic Workflows on Opportunistic Resources
     </b>
    </a>

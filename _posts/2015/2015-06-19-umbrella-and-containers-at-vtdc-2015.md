...
image: "/assets/blog/2015/umbrella-and-containers-at-vtdc-2015/912.0-3b8adf7b8d.png"
    ...
    <tr>
     <td>
      <div class="row justify-content-sm-center">
       <div class="col-sm-12">
        {% include figure.liquid path="/assets/blog/2015/umbrella-and-containers-at-vtdc-2015/912.0-3b8adf7b8d.png" title="(PDF)" class="img-fluid rounded z-depth-1" zoomable=true %}
       </div>
      </div>
     </td>
     <td>
      ...
      <br/>
      <a href="http://ccl.cse.nd.edu/research/papers/umbrella-vtdc15.pdf" style="color: navy;">
       <b>
      ...
      <br/>
      <i>
       Workshop on Virtualization Technologies in Distributed Computing (VTDC) at HPDC
      </i>
      , June, 2015.
      <a href="http://dx.doi.org/10.1145/2755979.2755982" style="color: navy;">
   ...
   <tbody>
    <tr>
     <td>
      <div class="row justify-content-sm-center">
       <div class="col-sm-12">
        {% include figure.liquid path="/assets/blog/2015/umbrella-and-containers-at-vtdc-2015/910.0-d501c2c856.png" title="(PDF)" class="img-fluid rounded z-depth-1" zoomable=true %}
       </div>
      </div>
     </td>
     <td>
      ...
      <br/>
      <a href="http://ccl.cse.nd.edu/research/papers/wq-docker-vtdc15.pdf" style="color: navy;">
       <b>
      ...
      , June, 2015.
      <a href="http://dx.doi.org/10.1145/2755979.2755984" style="color: navy;">

...
<ul>
<li>[WorkQueue] Worker warning when files cannot be executed in the scratch directory. (Ben Tovar)</li>
<li>[WorkQueue] Status connections are no longer counted as available workers. (Ben Tovar)</li>
<li>[Makeflow] Fix issue with using quotes ("...",'...') when specifying files. (Ben Tovar)</li>
<li>[Makeflow] Fix makeflow_monitor race condition on partially written log lines. (Ben Tovar)</li>
</ul>

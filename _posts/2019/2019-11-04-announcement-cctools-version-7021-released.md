...
<ul>
<li>[Makeflow] Fix segfault when using --submit-safe-mode. (Ben Tovar)</li>
<li>[WorkQueue] Fix memory leak error when accumulating capacity statistics. (Ben Tovar)</li>
<li>[WorkQueue] Do not count the factory as an available worker. (Ben Tovar)</li>
</ul>

...
<a href="http://www.cse.nd.edu/%7Eccl/research/pubs/weaver-clade2010.pdf">paper about Weaver</a>
...
<pre><br/>b = SQLDataSet (’db’,’biometrics','irises')<br/>nefs = Query(db,db.color='Blue')<br/><br/>conv = SimpleFunction('convertiristotemplate',outsuffix='bit')<br/>bits = Map(conv,nefs)<br/><br/>cmp = SimpleFunction('compareiristemplates')<br/>AllPairs(cmp,bits,bits,output='matrix.txt')<br/></pre>
...
<a href="http://dthain.blogspot.com/search/label/allpairs">AllPairs</a>

is the perfect example of this optimization -- you

<span style="font-weight: bold;">can</span>
...
<span style="font-weight: bold;">compiler for workflows</span>
